...
public class StartScreenAudio : MonoBehaviour
{
    ...
    {
        if (scene.name == "Enter Scene")
        {
            PlayStartScreenMusic();
        }
        else if (scene.name == "Plane Test")
        {
        ...
        if (isInitialized && musicAudioSource != null && startScreenMusic != null)
        {
            ...
            if (!musicAudioSource.isPlaying && scene.name == "Enter Scene")
            {
    ...
    public void PlayButtonClickSound()
    {
        ...
        {
            // Ensure audio source is ready for immediate playback
            sfxAudioSource.priority = 0; // Highest priority
